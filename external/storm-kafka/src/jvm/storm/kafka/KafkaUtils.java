...
public class KafkaUtils {
	...
	public static long getOffset(SimpleConsumer consumer, String topic, int partition, long startOffsetTime) {
		...
		if (offsets.length > 0) {
			LOG.debug("Got offset no. {} for topic {}, partition {}, start offset time {}, client id {}",
					offsets[0], topic, partition, startOffsetTime, consumer.clientId());
			return offsets[0];
		} else {
			LOG.debug("No offset found for topic {}, partition {}, start offset time {}, client id {}",
					topic, partition, startOffsetTime, consumer.clientId());
			return NO_OFFSET;
		}
	}
